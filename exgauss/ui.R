...
shinyUI(pageWithSidebar(headerPanel("exgauss"), sidebarPanel(sliderInput("mu", 
    ...
    sliderInput("sigma", "Value of σ", value = 20, min = 0.1, 
        ...
        value = 40, min = 1, max = 80, step = 2.72), sliderInput("numbr", 
        "Number of RTs", value = 6, min = 2L, max = 12L, step = 1L), 
    helpText("number of trials = 2^n \n4, 8, 16, 32, 64, 128, 256, 512, 1024  etc"), 
